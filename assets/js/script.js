var weatherAPIKey = "0d9389b8e5c848e04b9eadc2fa340181";
var city;
var cityChoice;
var cityName;
...
function citySearch(event, buttonText) {
  ...
  fetch('https://api.openweathermap.org/geo/1.0/direct?q=' + cityChoice + '&limit=1&appid=0d9389b8e5c848e04b9eadc2fa340181')
...
function callFiveDayForecast() {
  fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${apiLat}&lon=${apiLon}&appid=0d9389b8e5c848e04b9eadc2fa340181&units=imperial`)
  .then(function(rep){
      if(rep.ok) {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?lat='
     + apiLat + '&lon=' + apiLon + '&appid=0d9389b8e5c848e04b9eadc2fa340181&units=imperial')
     .then(function(res){
        if (res.ok) {
